...
int main(void) {
    ...
    return_value = bind(server_socket, reinterpret_cast<struct sockaddr *>(&my_addr), sizeof(struct sockaddr_in));
    ...
    for (;;) {
        ...
        return_value = select(FD_SETSIZE, &tests, nullptr, nullptr, nullptr);
